...
public class EmployeeTable {
    public static void insertEmployee(Employee emp) {
        ...
        /*Department dep;
        dep = emp.getDepartmentid();
        if(dep != null) {
            Collection<Employee> empCollection = dep.getEmployeeCollection();
            empCollection.add(emp);
            dep.setEmployeeCollection(empCollection);
            DepartmentTable.updateDepartment(dep);
        }*/
